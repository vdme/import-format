...
|residents|Жители(Собственники)|array|Да|Массив с [объектами, хранящими информацию о ителях и собственниках](#array-owners-object)|
...
|Поле|Название поля|Тип|Обязательное|Описание|
|---|---|---|---|---|
|type|Тип регистрации|enum('const','tmp')|Да|Возможные значения:<ul><li><b>const</b> - по месту жительства</li><li><b>tmp</b> - по месту пребывания</li></ul>||
