Последняя актуальная версия [https://github.com/kvado/import-format](https://github.com/kvado/import-format)
...
|saldo|Входящее сальдо|decimal(10,2)|Нет||
|calculated_area|Расчетная площадь|float|Да (только для коммунальных и совместных квартир)||
|owners|Собственники|array|Да|Массив с [объектами, хранящими информацию о собственниках](#array-owners-object)|
...
##### <a id="array-owners-object"></a>Описание объекта массива `owners`
...
|period|Период начисления|[Период](#type-period)|Да|Период начисления (например `2017-09-01` - сентябрь 2017)|
