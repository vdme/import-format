# Формат файла для выгрузки данных из 1С в JSON
...
|---|---|---|---|---|
|meters|Общедомовые счетчики|array|Да|Массив с [объектами, хранящими информацию об общедомовых приборах учета](#описание-объекта-в-массиве-meters)|
|premises|Помещения|array|Да|Массив с [объектами, хранящими информацию о помещениях](#описание-объекта-в-массиве-premises-помещения)|
...
|values|Показания по счетчику|array|Нет|[Массив объектов с показаниями](#описание-объекта-показаний-счетчика)|
...
|number_of_rooms|Количество комнат|int|Да||
|entrance|Номер подъезда|string|Нет||
|floor|Номер этажа|int|Да||
|radio|Наличие радио|bool|Да|`true` или `false`|
|number_of_tv|Количество ТВ-антенн|int|Да||
|meters|Приборы учета|array|Нет|Массив с [объектами, хранящими информацию об индивидуальных приборах учета](#описание-объекта-в-массиве-meters)|
|accounts|Лицевые счета|array|Да||
...
|residents|Количество проживающих|int|Да||
|calculated_area|Расчетная площадь|float|Да (только для коммунальных и совместных квартир)||
|owners|Собственники|array|Да|Массив с [объектами, хранящими информацию о собственниках](#описание-объекта-массива-owners)|
|rooms|Комнаты|array|Да (только для коммунальных и совместных квартир)|Массив с [объектами, хранящими информацию о комнатах ЛС](#описание-объекта-массива-rooms)|
|accruals|Начисления|object|Нет|Объект хранящий информацию о начислениях. Ключами являются периоды начислений (тип [Период](#type-period)), значениями объекты с [информацией о начислениях в периоде](#описание-значений-объекта-accruals)|
|payments|Платежи|array|Нет|Массив с [объектами, хранящими информацию о платежах](#описание-объекта-массива-payments)|

##### Описание объекта массива `owners`

|Поле|Название поля|Тип|Обязательное|Описание|
|---|---|---|---|---|
|type|Тип собственника|enum|Да|Возможные значения:<ul><li>физ. лицо</li><li>юр. лицо</li></ul>|
|share|Доля собственности|string|Да|В формате «142/584», «1/2», «1/1»|
...
|individual|Физ. лицо|object|Да (для `type = "физ. лицо"`)|Объект с [данными о владельце, если физ. лицо](#описание-объекта-массива-individual)|
|entity|Юр. лицо|object|Да (для `type = "юр. лицо"`)|Объект с [данными о владельце, если юр. лицо](#описание-объекта-массива-entity)|

###### Описание объекта массива `individual`
